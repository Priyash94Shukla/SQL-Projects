...
This project analyzes Amazon sales data using SQL to uncover insights related to sales performance, customer behavior, seller performance, and product profitability. The goal is to simulate real-world business analysis tasks performed by a Data Analyst.
...
- Subqueries & CTEs
- Date & Time Analysis
- Business Metrics (Revenue, Profit Margin, AOV)
- Procedures
